        ...
        <div class="row-fluid">
            ...
            <div class="btn-group">
                ...
                <form action="/servlet/TestSampleServlet" method="post">
                    <label>
                        ...
                        <input type="submit" style="margin-left: 20px" name="checkTestSample" value="查询"
            ...
            <div class="well">
                <table class="table" id="testSampleTable">
                    ...
                    %>
                    <tr>
                        <td><%=itemMap.get("TestSampleNo")%>
                        </td>
                        <td><%=itemMap.get("TestSampleName")%>
                        </td>
                        <td><%=itemMap.get("type")%>
                        </td>
                        <td><%=itemMap.get("creatorNo")%>
                        </td>
                        <td><%=itemMap.get("creatorName")%>
                        </td>
                        <td><%=itemMap.get("executorNo")%>
                        </td>
                        <td><%=itemMap.get("executorName")%>
                        </td>
                        <td><%=itemMap.get("result")%>
                        </td>
