  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <li ><a href="workerOperation_update.jsp" class="active">成员操作</a></li>
...
<div class="well">
    ...
    <form id="tab" method="post" action="/servlet/WorkerServlet">
        <label>原项目编号</label>
        <input type="text"  readonly="readonly" class="input-xlarge" name="originProjectNo" value="<%=request.getParameter("projectNo")==null?"":request.getParameter("projectNo")%>">
        <label>新项目编号</label>
        <input type="text" class="input-xlarge" name="newProjectNo">
        <label>原员工编号</label>
        <input type="text" readonly="readonly" class="input-xlarge" name="originWorkerNo" value="<%=request.getParameter("no")==null?"":request.getParameter("no")%>">
        <label>新员工编号</label>
        <input type="text" class="input-xlarge" name="newWorkerNo">
        <br>
        <input type="submit" value="修改" class="btn-primary" style="height: 40px;width: 80px;margin-left: 30px" name="changeWorker1">
    </form>
      </div>
