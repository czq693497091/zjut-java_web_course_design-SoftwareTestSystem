...
<div class="content">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <%--<a class="btn btn-primary" href="/developer/bugsOperation.jsp"><i class="icon-plus"></i> Bug</a>--%>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            %>
                            <%
                                if (item.get("developerNo").equals(((Person) session.getAttribute("Person")).getNo())) {
                            %>
                            <a href="/developer/bugsOperation.jsp?<%=href%>"><i
