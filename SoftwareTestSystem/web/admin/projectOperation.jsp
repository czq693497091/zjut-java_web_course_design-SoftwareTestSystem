...
<div class="well">
    ...
    <form id="tab" method="post" action="/servlet/WorkerInfoServlet">
        <%
            String projectNo = "";
            String projectName = "";
            String startDate = "";
        ...
        <input type="submit" value="添加" class="btn-primary" style="height: 40px;width: 80px;" name="addPerson">
        <input type="submit" value="修改" class="btn-primary" style="height: 40px;width: 80px;margin-left: 30px" name="changePerson">
    </form>
      </div>
