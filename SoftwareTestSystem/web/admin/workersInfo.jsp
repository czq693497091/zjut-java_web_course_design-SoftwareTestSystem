    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <a class="btn btn-primary" href="workersInfoOperation.jsp"><i class="icon-plus"></i> 成员</a>
            ...
            <div class="well">
                <table class="table" id="workersInfoTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <%
                                String href = "personNo=" + person.getNo();
                                href += "&personName=" + person.getName();
                                href += "&personPassword=" + person.getPassword();
                                href += "&personType=" + person.getType();
                                href += "&personSex=" + person.getSex();
                                href += "&personEmail=" + person.getEmail();
//                                System.out.println(href);
                            %>
                            <a href="workersInfoOperation.jsp?<%=href%>" class="icon-pencil"></a>
                        <a href="/servlet/WorkerInfoServlet?deletePerson=1&personNo=<%=person.getNo()%>"
