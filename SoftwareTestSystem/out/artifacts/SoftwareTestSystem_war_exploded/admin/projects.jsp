...
<div class="sidebar-nav">
    ...
    <ul id="dashboard-menu" class="nav nav-list collapse in">
        ...
        <li class="active"><a href="projects.jsp">项目列表</a></li>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <a class="btn btn-primary" href="projectOperation.jsp"><i class="icon-plus"></i> 项目</a>
                <button class="btn" onclick="Export('projectsTable')">导出</button>
            </div>
            <%
            ...
            %>
            <div class="btn-group">
                <form action="/servlet/projectServlet" method="post">
                    <label>
                        <span>项目编号：</span>
                        <input type="text" style="height: 20px" name="projectNo">
                        <span style="margin-left: 20px">项目名称：</span>
                        <input type="text" style="height: 20px" name="projectName">
                ...
                <table class="table" id="projectsTable">
                    ...
                    <%
                        ...
                        if (session.getAttribute("projectList") != null) {
                            arrayList = (ArrayList<Project>) session.getAttribute("projectList");
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="projectOperation.jsp?ProjectNo=<%=project.getNo()%>&ProjectName=<%=project.getName()%>&StartDate=<%=project.getStartDate()%>&EndDate=<%=project.getEndDate()%>&Status=<%=project.getStatus()%>"
                               >
                                <i class="icon-pencil"></i></a>
                            <a href="/servlet/projectServlet?deleteProject=1&projectNo=<%=project.getNo()%>" onclick="return confirm('确认要删除吗?')">
