...
//                        }
                    ...
                    <form id="tab" method="post" action="/servlet/BugServlet">
                        ...
                        <label>Bug名称</label>
                        <input type="text" class="input-xlarge" name="bugName" value="<%=bugName%>">
                        <label>类型</label>
                        <input type="text" class="input-xlarge" name="type" value="<%=type%>">
                        <label>测试者编号</label>
                        <input type="text" class="input-xlarge" name="testerNo" value="<%=((Person) session.getAttribute("Person")).getNo()%>" readonly="readonly">
                        <label>开发者编号</label>
                        <input type="text" class="input-xlarge" name="developerNo" value="<%=developerNo%>" id="developerNo">
                        <label>方案</label>
...
<script type="text/javascript">
    ...
    var bug = $("#bugNo");
    var developerNo = $("#developerNo")
    if (bug.val() != "") bug.attr("readonly", "readonly");
    if (developerNo.val()!="") developerNo.attr("readonly","readonly");
