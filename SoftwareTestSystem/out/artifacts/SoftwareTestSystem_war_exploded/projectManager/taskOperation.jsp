            ...
            <div class="well">
                ...
                <div class="tab-pane active in" id="home">
                    ...
                    <form id="tab" method="post" action="/servlet/TaskServlet">
                        ...
                        <label>项目经理编号</label>
                        <input type="text" class="input-xlarge" name="projectManagerNo" value="<%=((Person) session.getAttribute("Person")).getNo()%>"
                               id="projectManagerNo" readonly="readonly">
                        <label>产品经理编号</label>
                        <input type="text" class="input-large" name="productManagerNo" value="<%=productManagerNo%>">
                        <label>开发者编号</label>
                        <input type="text" class="input-large" name="developerNo" value="<%=developerNo%>">
                        <label>测试者编号</label>
                        <input type="text" class="input-large" name="testerNo" value="<%=testerNo%>">
                        <label>完成状态</label>
