...
<div class="sidebar-nav">
    ...
    <ul id="dashboard-menu" class="nav nav-list collapse in">
        ...
        <li class="active"><a href="workers.jsp">成员列表</a></li>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                ...
                <button class="btn" onclick="Export('workersTable')">导出</button>
            </div>
            ...
            <div class="well">
                <table class="table" id="workersTable">
                    ...
                    <%
                        ...
                        if (session.getAttribute("ProjectPersonList") != null) {
                            arrayList = (ArrayList<Map<String, String>>) session.getAttribute("ProjectPersonList");
                    ...
                    <tr>
                        ...
                        <td><%=itemMap.get("department")%>
                        </td>
                        <td><%=itemMap.get("sex")%>
                        </td>
                        <td><%=itemMap.get("email")%>
                        </td>
                        <td>
                            <a href="workerOperation_update.jsp?projectNo=<%=itemMap.get("projectNo")%>&no=<%=itemMap.get("no")%>"><i
                                    class="icon-pencil"></i></a>
                            <a href="/servlet/WorkerServlet?deleteWorker=1&projectNo=<%=itemMap.get("projectNo")%>&no=<%=itemMap.get("no")%>"
