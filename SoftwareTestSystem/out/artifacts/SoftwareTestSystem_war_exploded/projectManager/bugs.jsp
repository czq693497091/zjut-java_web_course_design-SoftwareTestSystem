    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <a class="btn btn-primary" href="/projectManager/bugsOperation.jsp"><i class="icon-plus"></i> Bug</a>
            ...
            <div class="well">
                <table class="table" id="bugsTable">
                    ...
                    <tr>
                        ...
                        <td><%=item.get("testerNo")%></td>
                        <td><%=item.get("testerName")%>
                        </td>
                        <td><%=item.get("developerNo")%></td>
                        ...
                        <td>
                            ...
                            %>
                            <a href="/projectManager/bugsOperation.jsp?<%=href%>"><i
