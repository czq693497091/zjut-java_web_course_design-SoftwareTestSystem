            ...
            <div class="well">
                <table class="table" id="workersInfoTable">
                    ...
                    <tr>
                        ...
                        <%--&lt;%&ndash;<a href="/servlet/WorkerServlet?deleteWorker=1&projectNo=<%=itemMap.get("projectNo")%>&no=<%=itemMap.get("no")%>" onclick="return confirm('确认删除?')" data-toggle="modal"><i class="icon-remove"></i></a>&ndash;%&gt;--%>
                        <%--</td>--%>
                    </tr>
                    <%
                            }
