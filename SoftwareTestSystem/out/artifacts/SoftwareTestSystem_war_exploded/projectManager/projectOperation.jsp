  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <li ><a href="projectOperation.jsp" class="active">项目操作</a></li>
...
<div class="well">
    ...
    <form id="tab" method="post" action="/servlet/projectServlet">
        <%
            String projectNo = "";
            String projectName = "";
            String startDate = "";
        ...
        <label>项目名称</label>
        <input type="text" class="input-xlarge" name="projectName" value="<%=projectName%>">
        <label>开始日期</label>
        <input type="text" class="input-xlarge" name="startDate" value="<%=startDate%>">
        <label>截止日期</label>
        <input type="text" class="input-xlarge" name="endDate" value="<%=endDate%>">
        <label>完成状态</label>
        <input type="text" class="input-large" name="status" value="<%=status%>"><br>
        <input type="submit" value="添加" class="btn-primary" style="height: 40px;width: 80px;" name="addProject1">
        <input type="submit" value="修改" class="btn-primary" style="height: 40px;width: 80px;margin-left: 30px" name="changeProject1">
    </form>
      </div>
